 ...
 * @ZBC_ZONE_REPORTING_OPTION_IMPLICIT_OPEN: Zones open but not explicitly opened
 ...
 * @ZBC_ZONE_REPORTING_OPTION_RESERVED: Zones that with Non-Sequential Write Resources Active
 * @ZBC_ZONE_REPORTING_OPTION_NON_WP: Zones that do not have Write Pointers (conventional)
 * @ZBC_ZONE_REPORTING_OPTION_RESERVED: Undefined
 * @ZBC_ZONE_REPORTING_OPTION_PARTIAL: Modifies the definition of the Zone List Length field.
 *
...
static __inline__ u32 max_report_entries(size_t bytes)
{
